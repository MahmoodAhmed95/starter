...
const tweet = {
  ...
  user: {
    ...
    profile_image_url:
      "http://pbs.twimg.com/profile_images/585565077207678977/N_eNSBXi_normal.jpg",
...
console.log(product.product.variant.image_id);
console.log(tweet.user.friends_count);
console.log(tweet.user.entities.url.url);
console.log(tweet.extended_entities.media.sizes);
